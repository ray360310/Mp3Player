...
public class Bluetoothservice {
     ...
     */
    public static Bluetoothservice createService(Context context, Handler handler) {
    	if (mService == null)
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(Mp3Player_main.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(Mp3Player_main.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(Mp3Player_main.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(Mp3Player_main.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Mp3Player_main.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(Mp3Player_main.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Mp3Player_main.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
                    ...
                    synchronized (Bluetoothservice.this) {
                        ...
                        case STATE_CONNECTED:
                            ...
                            try {
                                ...
                                Log.i(TAG, "mmServersocket close");
                            } catch (IOException e) {
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (connectcheck) {
                try {
                    ...
                    if(D) Log.i(TAG,Integer.toString(bytes));
                    String readMessage;
                    readMessage = new String(buffer,0,bytes);
                    if(D) Log.i(TAG,readMessage);
                    if (readMessage.equals("dct"))
                    	cancel();
                    // Send the obtained bytes to the UI Activity
                    mHandler.obtainMessage(Mp3Player_main.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                    if (readMessage.equals("dct"))
                    	mService = null;
        ...
        public void cancel() {
            try {
                mmSocket.close();
                connectcheck=false;
                if(D) Log.i(TAG,"mmSocket closed");
            } catch (IOException e) {
